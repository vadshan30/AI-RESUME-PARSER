...
import HiringProbability from './pages/HiringProbability';
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/dashboard/learning-roadmap" element={<Roadmap />} />
      ...
      <Route path="/dashboard/hiring-probability" element={<HiringProbability />} />
      ...
      <Route path="/analysis/:id" element={<Navigate to={`/dashboard/analysis/${window.location.pathname.split('/').pop()}`} replace />} />
